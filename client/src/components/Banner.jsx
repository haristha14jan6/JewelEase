  ...
  return (
    ...
    [#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      <div className='text-white'>
        <h2 className='text-3xl font-medium'>Do you Own a Luxury Jewel?</h2>
        <p className='mt-2'>Monetize your vehicle effortlessly by listing it on JewelRental.</p>
        ...
        text-primary rounded-lg text-sm mt-4 cursor-pointer'>List your jewel</motion.button>
      </div>
<motion.img
initial={{opacity:0,x:50}}
whileInView={{opacity:1,x:0}}
transition={{duration:0.6,delay:0.4}}
src={assets.jewellery_banner} alt="jewel" className='max-h-45 mt-10'/>
    </motion.div>
  )
}
