...
const Hero = () => {
  ...
  const handleSearch=(e)=>{
    e.preventDefault()
    navigate('/jewels?pickupLocation='+pickupLocation+'&pickupDate='+pickupDate+'&returnDate='+returnDate)
  }
  ...
  return (
    ...
    transition={{duration:0.8}}
      ...
      className='text-3xl md:text-4xl font-semibold'>Luxury Jewels on Rent</motion.h1>
      ...
      <div className="flex flex-wrap justify-center gap-6">
        <motion.img
         ...
         transition={{duration:0.8,delay:0.6}}
          src={assets.img1}
          alt="Jewel 1"
          className="w-[180px] md:w-[220px] rounded-xl shadow-md hover:scale-105 transition-transform duration-300"
        />
        <motion.img
