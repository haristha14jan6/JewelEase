...
const MyBookings = () => {
  ...
  return (
    ...
    max-w-7xl'>
      ...
      subTitle='View and manage your all jewel bookings'
      align="left"/>
      <div>
        {
         ...
         p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
          ...
          <div className='md:col-span-1'>
            <div className='rounded-md overflow-hidden mb-3'>
              <img src={booking.jewel.image} alt="" className='w-full h-auto 
              aspect-video object-cover'/>
            </div>
            <p>{booking.jewel.brand}{booking.jewel.model}</p>
            <p className='text-gray-500'>{booking.jewel.year} . {booking.jewel.category}.{booking.jewel.location}</p>
            </div>
            {/*Booking Info */}
